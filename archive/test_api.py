...
async def main():
    # Test movie requests
    movie_requests = await get_movie_requests(status="available", start_date="2023-01-01T00:00:00.000Z")
    print("Movie Requests:")
    print(movie_requests)
    
    # Test TV requests
    tv_requests = await get_tv_requests(status="available", start_date="2023-01-01T00:00:00.000Z")
    print("\nTV Requests:")
    print(tv_requests)
