...
```bash
npx @modelcontextprotocol/inspector uv --directory /path/to/mcp-overseerr run mcp-overseerr
```
...
```bash
tail -n 20 -f ~/Library/Logs/Claude/mcp-server-mcp-overseerr.log